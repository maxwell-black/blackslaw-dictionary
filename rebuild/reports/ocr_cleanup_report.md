...
| Term | Fixes Applied |
|------|--------------|
| ACCOUNT | hyphen_rejoin(1) |
| AD IDEM | hyphen_rejoin(1) |
| ADIPOCERE | hyphen_rejoin(1) |
| AGGRAVATION | hyphen_space_rejoin(1) |
| ANIMAL | hyphen_rejoin(1) |
| ARRECT | hyphen_rejoin(1) |
| ARSON | hyphen_rejoin(2) |
| AUTOCRACY | hyphen_rejoin(1) |
| BAIL | hyphen_rejoin(1) |
| BEST EVIDENCE | hyphen_rejoin(2) |
| BONI HOMINES | hyphen_rejoin(2) |
| BRANCH | hyphen_rejoin(4) |
| CARE | hyphen_rejoin(1) |
| CARIAGIUM | hyphen_rejoin(1) |
| COMPLAINT | hyphen_rejoin(1) |
| CURIA | hyphen_rejoin(5) |
| DEBT | hyphen_rejoin(2) |
| DEFAULT | hyphen_rejoin(1) |
| DEFOROIATIO | hyphen_rejoin(1) |
| DESPONSATION | hyphen_space_rejoin(1) |
| DESPOT | hyphen_rejoin(3) |
| DISCONTINUANCE | hyphen_rejoin(1) |
| DOMO | hyphen_space_rejoin(1) |
| DUCROIRE | hyphen_rejoin(1) |
| DUPLICATE | hyphen_rejoin(1) |
| EMPLOY | hyphen_space_rejoin(1) |
| ESTATE | hyphen_rejoin(1) |
